...
CREATE TABLE IF NOT EXISTS paper_fills(id TEXT PRIMARY KEY,order_id TEXT NOT NULL,timestamp TEXT NOT NULL,symbol TEXT NOT NULL,side TEXT NOT NULL,quantity INTEGER NOT NULL,fill_price TEXT NOT NULL,commission TEXT NOT NULL,realized_pnl TEXT NOT NULL,payload TEXT NOT NULL);
CREATE TABLE IF NOT EXISTS paper_positions(symbol TEXT PRIMARY KEY,quantity INTEGER NOT NULL,average_price TEXT NOT NULL,last_price TEXT NOT NULL,high_price TEXT NOT NULL,opened_at TEXT NOT NULL,updated_at TEXT NOT NULL,current_score REAL,data_timestamp TEXT,position_status TEXT NOT NULL DEFAULT 'UNKNOWN');
